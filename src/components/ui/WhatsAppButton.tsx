...
export function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[200] group">
      {/* Tooltip */}
      <span className="pointer-events-none absolute right-full top-1/2 -translate-y-1/2 mr-3 whitespace-nowrap bg-slate-900 text-white text-xs font-semibold px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-150 shadow-lg">
        Chat on WhatsApp
