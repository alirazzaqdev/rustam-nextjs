...
export function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[200] flex flex-col items-end gap-3">
          ...
          >
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-bold text-slate-900 text-sm">Rustam Battery</p>
            ...
            <div className="bg-slate-50 rounded-xl p-3 mb-3 text-sm text-slate-700">
              👋 Assalam o Alaikum! Solar panels ya batteries ke baray mein maloomat chahiye? Hum madad karne ke liye hain!
            </div>
      ...
      {/* Main button + tooltip wrapper */}
      <div className="relative group">
        {/* Hover tooltip */}
        <span className="pointer-events-none absolute right-full top-1/2 -translate-y-1/2 mr-3 whitespace-nowrap bg-slate-900 text-white text-xs font-semibold px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 shadow-lg">
          Chat on WhatsApp
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="relative w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-xl shadow-green-200 flex items-center justify-center transition-colors"
