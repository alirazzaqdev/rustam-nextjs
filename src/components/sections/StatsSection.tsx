...
const STATS = [
  { target: 10,  suffix: '+',  micro: 'SINCE 2016',  label: 'Years of expertise'   },
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4">
          {STATS.map((stat, i) => (
            ...
            >
              ...
              >
                {counts[i]}<span className="text-amber-500">{stat.suffix}</span>
              </p>

              <div className="w-8 h-0.5 bg-amber-400 rounded-full my-4 group-hover:w-12 transition-all duration-500" />
