export default function JsonLd() {
  const localBusiness = {
    ...
    description: "Pakistan's trusted solar energy company since 2006. Solar panels, batteries, and Knox inverters for residential, commercial and industrial customers in Lahore.",
    ...
    itemListElement: [
      {
        ...
        item: {
          ...
          offers: { '@type': 'Offer', price: '14214', priceCurrency: 'PKR', availability: 'https://schema.org/InStock', seller: { '@type': 'Organization', name: 'Rustam Battery' } },
        },
      },
      {
        '@type': 'ListItem',
        ...
        item: {
          ...
          offers: { '@type': 'Offer', price: '120500', priceCurrency: 'PKR', availability: 'https://schema.org/InStock', seller: { '@type': 'Organization', name: 'Rustam Battery' } },
        },
      },
      {
        '@type': 'ListItem',
        ...
        item: {
          ...
          offers: { '@type': 'Offer', price: '26179', priceCurrency: 'PKR', availability: 'https://schema.org/InStock', seller: { '@type': 'Organization', name: 'Rustam Battery' } },
        },
      },
    ],
  }
